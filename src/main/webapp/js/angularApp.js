    ...
    $scope.getByIdOrganization = function () {
        ...
        $http.get(url, config).then(function (response) {
            ...
            if (response.data.result == "success") {
                ...
                $scope.isActive = list.data.isActive;
                //$scope.isActive = $scope.organization.data.isActive;

            } else {
                $scope.resultMessage = "Organization Data Error!";
            }
    ...
    $scope.getOfficeById = function () {
        ...
        $http.get(url, config).then(function (response) {
            ...
            if (response.data.result == "success") {
                ...
                $scope.setView($scope.office.id, list.name, list.address, list.phone, list.isActive);

                FactoryOffice.updateOfficeData($scope.office.id, list.name, list.address, list.phone, list.isActive);
...
app.controller('postOfficeControllerUpdate', function ($scope, $http, $location, FactoryOrgId, FactoryOffice) {
    ...
    $scope.postOfficeUpdate = function () {
        ...
        $http.post(url, data, config).then(function (response) {
            ...
            if (response.data.result == "success") {
                /* var list = response.data.data;
                 $scope.setView($scope.id, list.name, list.address, list.phone, list.isActive);
                 FactoryOffice.updateOfficeData($scope.office.id, list.name, list.address, list.phone, list.isActive);*/
...
app.controller('postOfficeControllerSave', function ($scope, $http, $location, FactoryOffice, FactoryOrgId) {
    ...
    $scope.postOfficeSave = function () {
        ...
        $http.post(url, data, config).then(function (response) {
            if (response.data.result == "success") {
                var list = response.data.data;
                // $scope.setView('', list.name, list.address, list.phone, list.isActive);
